    ...
    <div className="bg-[#486D8D] p-[3vw] pb-[30px]">
      ...
      <div className="pl-[3.9vw] pr-[3.4vw] h-[13.5vw] flex items-center justify-between fixed top-0 left-0 z-[999] right-0 bg-[#486D8D]">
        <div className="flex items-center">
          ...
          <span className="ml-2 text-[white] text-[16px]">歌单</span>
        </div>
        <div className="flex items-center">
      ...
      <div className="flex items-center mt-[3.5vw] justify-between">
        ...
        <div className="flex items-center justify-center h-[9.9vw] rounded-[200px] bg-opacity-20 bg-[#fff] font-[800] flex-1 text-[#f8fefe] text-[3vw] ml-2">
          <Icon icon="fluent:chat-20-filled" color="white" className="text-[5vw] mr-[1.8vw] iconify iconify--majesticons" />
          {song?.commentCount}
        </div>
        <div className="ml-2 flex items-center justify-center h-[9.9vw] rounded-[200px] bg-[#ff2658] font-[800] flex-1 text-[#f8fefe] text-[3vw]">
