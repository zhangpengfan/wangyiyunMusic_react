...
export default function PlayPage() {
    ...
    console.log(musicurl?.data?.data[0]?.time)
    //时间转换
    ...
    console.log(conversion(musicurl?.data?.data[0]?.time))
    console.log("歌词", musiclyricText)
    return (
            ...
            <div className="h-[100vh] w-[100%] absolute top-0 overflow-hidden">
                ...
                <div onClick={() => setshow(!show)} className="relative top-[10%] w-[100%] h-[120vw]">
                    <div className="absolute top-[10%] left-[50%] translate-x-[-50%] z-[10] rotated w-[25vw] h-[40vw]">
                        <img src="https://admirable-jalebi-ce44af.netlify.app/static/needle-ab.png" alt="" className="absolute top-[6%] left-[30%] translate-x-[-50%] z-[10] rotated w-[30vw] h-[40vw]"
                    ...
                    <div className="w-[80vw] h-[80vw] absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-45%]">
                        ...
                        <audio src={musicurldata?.data[0]?.url} loop autoplay="true" ref={audioElementRef}></audio>
                    </div>
                </div>
                ...
                <div className="fixed bottom-0 left-0 w-[100%] p-[4vw]">
                    ...
                    <div className="h-[8vw] w-[100%] flex items-center  mt-[3vw] justify-between">
                        ...
                        <div className="flex-1 mx-[2.5vw]">
                            <ProgressBar percent={50} style={{ '--track-width': '4px', }} />
                        </div>
                        <div className="text-[#fff] text-[1.6vw] scale-[0.8] opacity-50">{conversion(musicurl?.data?.data[0]?.time)}</div>
                    </div>
                    {/* 播放控件 */}
